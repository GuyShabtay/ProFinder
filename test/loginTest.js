...
describe("login test",function(){
    it("login test",async function(){
        ...
        await driver.get('https://profinder-vzbv.onrender.com/LoginPage');
        ...
        await driver.wait(until.urlIs('https://profinder-vzbv.onrender.com/LoginPage'), 10000);

        // Get the current URL
        const currentUrl = await driver.getCurrentUrl();

        // Assert if the current URL matches the expected URL
        assert.equal(currentUrl, 'https://profinder-vzbv.onrender.com/LoginPage', 'Expected URL does not match actual URL');
